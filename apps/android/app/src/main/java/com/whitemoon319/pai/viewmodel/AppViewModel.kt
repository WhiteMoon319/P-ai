...
import com.whitemoon319.pai.service.ChatService
import com.whitemoon319.pai.bridge.ConnectionStatus
import com.whitemoon319.pai.bridge.NativeEventPump
...
class AppViewModel(
    ...
    val connectionState: StateFlow<ConnectionStatus> = eventPump.connectionState
    ...
    fun start() {
        ...
        notificationJob = scope.launch(Dispatchers.IO) {
            ...
            eventPump.notifications.collect { (method, params) ->
    ...
    private fun handleNativeKeepAlive(params: JsonElement?) {
        ...
        try {
            ...
            if (active) {
                com.whitemoon319.pai.platform.PaiForegroundService.start(appContext)
            } else {
                com.whitemoon319.pai.platform.PaiForegroundService.stop(appContext)
            }
        } catch (e: Exception) {
