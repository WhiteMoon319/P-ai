//! 远程 IM 秘书决策的标签/消息格式/提示词构造纯逻辑（阶段 6 迁入）。
//!
//! 全部为零 AppState 的纯函数：联系人标签、消息摘要格式化、秘书应答提示词构造。

use pai_backend::core::domain::runtime_types::PreparedPrompt;
use pai_backend::core::time_semantics::format_utc_storage_time_to_local_relative_label;
use pai_backend::core::domain::types_chat::{
    AgentProfile, ChatMessage, MessagePart, RemoteImConversationAssistantContext,
};
use pai_backend::core::domain::types_storage::{
    default_remote_im_contact_response_guidance, RemoteImContact,
};
use pai_backend::core::domain::types_requests::AttachmentMetaInput;

use crate::chat::conversation_utils::is_context_compaction_message;
...
pub struct RemoteImSecretaryMessageDigest {
...
pub fn normalize_remote_im_channel_response_guidance(value: &str) -> String {
...
pub fn remote_im_secretary_contact_type_label(contact_type: &str) -> &str {
...
pub fn remote_im_secretary_contact_display_name(contact: &RemoteImContact) -> String {
...
pub fn remote_im_secretary_context_display_name(name: &str, id: &str, fallback_name: &str) -> String {
    let name = name.trim();
    let id = id.trim();
...
pub fn remote_im_secretary_named_label(
    prefix: &str,
    name: &str,
    id: &str,
    fallback_name: &str,
...
pub fn remote_im_secretary_message_speaker_label(
    message: &ChatMessage,
...
pub fn remote_im_secretary_truncate_text(text: &str, max_chars: usize) -> String {
    text.chars().take(max_chars).collect::<String>()
}


pub fn remote_im_secretary_message_time_text(created_at: &str) -> String {
...
pub fn remote_im_secretary_message_line(
...
pub fn remote_im_secretary_message_digest(
    message: &ChatMessage,
    contact: &RemoteImContact,
    agents: &[AgentProfile],
    current_assistant: &RemoteImConversationAssistantContext,
...
pub fn remote_im_collect_secretary_recent_messages(
...
pub fn remote_im_secretary_messages_to_text(
...
pub fn build_remote_im_secretary_prepared_prompt(
    language: &str,
    contact: &RemoteImContact,
...
pub fn remote_im_secretary_extract_json(raw: &str) -> &str {
