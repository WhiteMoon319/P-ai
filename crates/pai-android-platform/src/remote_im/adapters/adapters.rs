...
use pai_backend::multilingual::markdown_filter::remote_im_filter_markdown_content_items;
...
// 通过 pub use 引入。
pub use crate::remote_im_sdk::RemoteImSdk;

pub fn remote_im_payload_text(payload: &Value) -> String {
    payload
        .get("content")
...
pub fn remote_im_onebot_message_segments(payload: &Value) -> Vec<Value> {
...
pub fn remote_im_payload_has_non_text_items(payload: &Value) -> bool {
...
pub fn remote_im_file_ext_from_name(file_name: &str) -> String {
...
pub fn remote_im_json_or_text(response_text: &str) -> Value {
...
pub fn remote_im_is_dingtalk_private_target_likely_conversation_id(remote_contact_id: &str) -> bool {
...
pub use crate::remote_im::feishu_sdk::*;

pub struct DingtalkSdk;

impl DingtalkSdk {
    pub async fn access_token(&self, channel: &RemoteImChannelConfig) -> Result<String, String> {
    ...
    // ========== input validation ==========
    pub fn validate_and_get_text(&self, payload: &Value) -> Result<String, String> {
    ...
    // ========== auth ==========
    pub async fn access_token_for_channel(
        &self,
    ...
    pub fn get_robot_code(&self, channel: &RemoteImChannelConfig) -> Option<String> {
    ...
    pub fn session_webhook_from_contact(&self, contact: &RemoteImContact) -> Option<String> {
        contact
    ...
    pub fn session_webhook_expired(&self, contact: &RemoteImContact) -> bool {
    ...
    pub fn validate_target_is_private(&self, contact: &RemoteImContact) -> Result<(), String> {
    ...
    pub async fn send_via_session_webhook(
        &self,
        client: &reqwest::Client,
        webhook: &str,
        text: &str,
    ...
    pub fn process_query_key_from_response(&self, body: &Value) -> String {
...
pub fn remote_im_sdk_for_platform(platform: &RemoteImPlatform) -> Box<dyn RemoteImSdk> {
    match platform {
...
pub fn remote_im_payload_with_channel_markdown_filtered(
    channel: &RemoteImChannelConfig,
    payload: &Value,
) -> Value {
...
#[cfg(test)]
pub fn remote_im_mock_send_via_sdk(
    channel: &RemoteImChannelConfig,
    contact: &RemoteImContact,
    payload: &Value,
...
pub async fn remote_im_send_via_sdk(
    channel: &RemoteImChannelConfig,
    contact: &RemoteImContact,
    payload: &Value,
...
#[cfg(test)]
pub mod remote_im_adapter_tests {
    use super::*;
    use pai_backend::core::domain::types_storage::{
        default_remote_im_contact_blocked_message_prefixes,
        default_remote_im_contact_mute_duration_seconds,
        default_remote_im_contact_mute_keywords,
        default_remote_im_contact_patience_seconds,
        default_remote_im_contact_response_guidance,
        default_remote_im_contact_response_strategy,
        default_remote_im_contact_unmute_keywords,
        RemoteImChannelBehaviorSettings, RemoteImGroupReplyPacing,
    };
